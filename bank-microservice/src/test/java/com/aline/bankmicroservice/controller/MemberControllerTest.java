...
class MemberControllerTest {
    ...
    void setup() {
        ...
        testMember = new Member(1L, testBranch, "1111", testApplicant, accounts);
        testMemberTwo = new Member(2L, testBranch, "1112", testApplicantTwo, accounts);
        Member testMemberThree = new Member(3L, testBranch, "2223", testApplicantThree, accounts);
