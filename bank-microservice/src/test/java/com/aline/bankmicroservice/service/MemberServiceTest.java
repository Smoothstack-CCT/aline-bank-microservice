...
class MemberServiceTest {
    ...
    void setUp() {
        ...
        Member testMember = new Member(1L, testBranch, "12345351635", testApplicant, new HashSet<>());
        Member testMemberTwo = new Member(2L, testBranch, "7890351651", testApplicant, new HashSet<>());
        Member testMemberThree = new Member(3L, testBranch, "98765321321", testApplicant, new HashSet<>());
